...
set_property PACKAGE_PIN V19 [get_ports {outLED[3]}]
set_property PACKAGE_PIN U19 [get_ports {outLED[2]}]
set_property PACKAGE_PIN E19 [get_ports {outLED[1]}]
set_property PACKAGE_PIN U16 [get_ports {outLED[0]}]
