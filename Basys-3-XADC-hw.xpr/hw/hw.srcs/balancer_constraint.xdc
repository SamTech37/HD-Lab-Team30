...
# Constraint for 2D ball balancer fpga
...
##Pmod Header JXADC
##Sch name = XA1_P (JXAC1)
set_property PACKAGE_PIN J3 [get_ports {x_pos_driver}] 
set_property IOSTANDARD LVCMOS33 [get_ports {x_pos_driver}]
##Sch name = XA2_P (JXAC2)
# y_volt_input
set_property PACKAGE_PIN L3 [get_ports {x_neg_driver}]
set_property IOSTANDARD LVCMOS33 [get_ports {x_neg_driver}]
##Sch name = XA3_P (JXAC3)
set_property PACKAGE_PIN M2 [get_ports {y_pos_driver}]
set_property IOSTANDARD LVCMOS33 [get_ports {y_pos_driver}]
#Sch name = XA4_P (JXAC4)
# x_volt_input
...
##Sch name = XA2_N 
set_property PACKAGE_PIN M3 [get_ports {y_ground}]
set_property IOSTANDARD LVCMOS33 [get_ports {y_ground}]
##Sch name = XA3_N
# set_property PACKAGE_PIN M1 [get_ports {JXADC[6]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[6]}]
##Sch name = XA4_N
set_property PACKAGE_PIN N1 [get_ports {x_ground}]
set_property IOSTANDARD LVCMOS33 [get_ports {x_ground}]
