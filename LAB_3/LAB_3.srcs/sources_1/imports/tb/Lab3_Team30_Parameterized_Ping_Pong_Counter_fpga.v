...
always @(posedge clk) begin
    ...
    4'b0000: cntLED1 <= 7'b0000001; // "0"     
    4'b0001: cntLED1 <= 7'b1001111; // "1" 
    4'b0010: cntLED1 <= 7'b0010010; // "2" 
    4'b0011: cntLED1 <= 7'b0000110; // "3" 
    4'b0100: cntLED1 <= 7'b1001100; // "4" 
    4'b0101: cntLED1 <= 7'b0100100; // "5" 
    4'b0110: cntLED1 <= 7'b0100000; // "6" 
    4'b0111: cntLED1 <= 7'b0001111; // "7" 
    4'b1000: cntLED1 <= 7'b0000000; // "8"     
    4'b1001: cntLED1 <= 7'b0000100; // "9" 
    4'b1010: cntLED1 <= 7'b0001000; // "A" 
    4'b1011: cntLED1 <= 7'b1100000; // "b" 
    4'b1100: cntLED1 <= 7'b1110010; // "c" 
    4'b1101: cntLED1 <= 7'b1000010; // "d" 
    4'b1110: cntLED1 <= 7'b0110000; // "E" 
    4'b1111: cntLED1 <= 7'b0111000; // "F" 
    default: cntLED1 <= 7'b0000001; // "0"
    endcase
...
assign pb_debounced = (DFF == 4'b11111)? 1'b1 : 1'b0;

endmodule

//one-pulse
module One_Pulse(clk,  pb_debounced, pb_onepulse);
